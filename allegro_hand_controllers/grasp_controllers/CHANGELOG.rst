^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package allegro_hand_grasp_controllers
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
2.28.0 (2023-11-30)
-------------------
* Fixed implementation so that effort_controllers/AllegroHandGraspController works. (`#756 <https://github.com/ros-controls/ros2_controllers/issues/756>`_) (`#868 <https://github.com/ros-controls/ros2_controllers/issues/868>`_)
* Contributors: mergify[bot]
...
2.17.2 (2023-03-07)
-------------------
* Fix Segfault in AllegroHandGraspController (`#527 <https://github.com/ros-controls/ros2_controllers/issues/527>`_) (`#530 <https://github.com/ros-controls/ros2_controllers/issues/530>`_)
